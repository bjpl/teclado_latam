...
export const LATAMKeyboardLayout: KeyboardLayout = {
  ...
  rows: [
    ...
    [
      ...
      createKey('IntlBackslash', 3, 1, 1.0, '<', '>', null, null, 'left-pinky'),
      createKey('KeyZ', 3, 2, 1.0, 'z', 'Z', null, null, 'left-pinky'),
      createKey('KeyX', 3, 3, 1.0, 'x', 'X', null, null, 'left-ring'),
      createKey('KeyC', 3, 4, 1.0, 'c', 'C', null, null, 'left-middle'),
      createKey('KeyV', 3, 5, 1.0, 'v', 'V', null, null, 'left-index'),
      createKey('KeyB', 3, 6, 1.0, 'b', 'B', null, null, 'left-index'),
      createKey('KeyN', 3, 7, 1.0, 'n', 'N', null, null, 'right-index'),
      createKey('KeyM', 3, 8, 1.0, 'm', 'M', null, null, 'right-index'),
      createKey('Comma', 3, 9, 1.0, ',', ';', null, null, 'right-middle'),
      createKey('Period', 3, 10, 1.0, '.', ':', null, null, 'right-ring'),
      createKey('Slash', 3, 11, 1.0, '-', '_', null, null, 'right-pinky'),
      createKey('ShiftRight', 3, 12, 2.75, '', '', null, null, 'right-pinky'),
    ],
    // Row 4: Space bar row
    [
      createKey('ControlLeft', 4, 0, 1.25, '', '', null, null, 'left-pinky'),
      createKey('MetaLeft', 4, 1, 1.25, '', '', null, null, 'left-pinky'),
      createKey('AltLeft', 4, 2, 1.25, '', '', null, null, 'left-pinky'),
      createKey('Space', 4, 3, 6.25, ' ', ' ', null, null, 'thumb'),
      createKey('AltRight', 4, 4, 1.25, '', '', null, null, 'right-pinky'),
      createKey('MetaRight', 4, 5, 1.25, '', '', null, null, 'right-pinky'),
      createKey('ContextMenu', 4, 6, 1.25, '', '', null, null, 'right-pinky'),
      createKey('ControlRight', 4, 7, 1.25, '', '', null, null, 'right-pinky'),
    ],
  ],
};
